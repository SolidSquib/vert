...
#include "Online.h"
#include "VertGameSession.generated.h"

struct FVertSessionParams
{
...
UCLASS(config=Game)
class VERT_API AVertSession : public AGameSession
{
...
protected:
	...
	FVertSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FVertOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FVertOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(AVertSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(AVertSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	...
	DECLARE_EVENT_OneParam(AVertSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
