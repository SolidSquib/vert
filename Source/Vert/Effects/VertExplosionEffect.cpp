...
#include "Vert.h"
#include "VertExplosionEffect.h"

AVertExplosionEffect::AVertExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AVertExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void AVertExplosionEffect::Tick(float DeltaSeconds)
{
